...
i plan to add more to this ghost in the future yeahhh but for now he is no more than a stick that yaps :)
...
- Issues with network updates but admittedly i might be a little incompetent with this specific feature so it'll prolly take a minute to fix :( sorrgy
- A few typos
